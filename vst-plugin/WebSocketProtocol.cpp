...
MessageType parseType(const juce::String& type) {
  ...
  if (type == "meter")        return MessageType::Meter;
  if (type == "settings")     return MessageType::Settings;
  if (type == "get_settings") return MessageType::GetSettings;
  if (type == "set_settings") return MessageType::SetSettings;
